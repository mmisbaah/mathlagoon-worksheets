const CACHE='worksheet-hub-v8';
const APP_SHELL=[
  '/', '/index.html', '/manifest.webmanifest',
  '/assets/activities.css','/assets/interface.css','/assets/print.css','/assets/app-icon.svg','/assets/browser-icon-v2.png','/assets/fraction-foods.png',
