...
(function(){
  ...
  function genMathProblems(op, count) {
    const challenge = Number(document.getElementById('l3-section-math').dataset.challenge);
    mathProblems = challenge ? WorksheetCore.getChallenge(3, op, challenge) : WorksheetCore.generate(3, op, count);
    mathChecked = false;
