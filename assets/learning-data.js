(function(root){
  ...
  root.WorksheetLearning={
    ...
    examples:{
      ...
      '1-fractions':E('One half of a beach flag',['The flag is split into 2 equal parts.','One of those equal parts is shaded, so one half is shaded.'],'Check that every part is the same size.'),
      ...
      '2-fractions':E('Write the shaded fraction',['Count all the equal parts for the bottom number.','Count the shaded parts for the top number.'],'Count all parts first, then the shaded parts.'),
      ...
      '3-fractions':E('Make an equivalent fraction',['Multiply the top and bottom by the same number.','One half equals two quarters because 1 × 2 = 2 and 2 × 2 = 4.'],'Use the same multiplier on both numbers.'),
      ...
      '4-fractions':E('Simplify and add fractions',['For the same denominator, add the numerators.','Divide the numerator and denominator by a common factor to simplify.'],'Keep a shared denominator, then simplify.'),
      ...
      ,'5-fractions':E('Calculate with unlike fractions',['Find a common denominator.','Rewrite both fractions, calculate, then simplify.'],'Check whether the denominators match before calculating.')
    },
    levelArithmetic:{
