...
test('versioned critical assets bypass older offline caches',()=>{
  ...
  for(const asset of ['assets/interface.css?v=8','assets/core.js?v=6','assets/fractions.js?v=1','assets/progression.js?v=8','assets/printing.js?v=3'])assert.ok(html.includes(asset),asset);
});
